...
In ArtificialTheorems, I have set up a template for robust verification: having a Specs directory containing just the theorem statements, then verifying the proofs against the specs using [SafeVerify](https://github.com/GasStationManager/SafeVerify) and Comparator. I have scripts that run these locally as well as in GitHub CI. I do recommend anyone that is doing an autoformalization project to adopt a verification framework like this.
